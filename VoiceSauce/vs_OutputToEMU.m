...
for k=1:length(matfilelist)
    ...
    for n=1:length(params)
        ...
        if (strcmp(param,'pF1') || strcmp(param,'pF2') || strcmp(param,'pF3') || strcmp(param,'pF4') || strcmp(param,'pB1') || strcmp(param,'pB2') || strcmp(param,'pB3') || strcmp(param,'pB4'))
            
            %combine the praat formants and bandwidth into a single ssff
            
            if strcmp(param,'pF1')
                
                outfile = [VSData.vars.OTE_outputdir VSData.vars.dirdelimiter matfilelist{k}(1:end-3) 'pfb'];
                ...
                func_VSformants2ssff([mdata.pF1,mdata.pF2,mdata.pF3,mdata.pF4,mdata.pB1,mdata.pB2,mdata.pB3,mdata.pB4], 'p', outfile, VSData.vars);
        ...
        elseif (strcmp(param,'sF1') || strcmp(param,'sF2') || strcmp(param,'sF3') || strcmp(param,'sF4') || strcmp(param,'sB1') || strcmp(param,'sB2') || strcmp(param,'sB3') || strcmp(param,'sB4'))
            
            if strcmp(param,'sF1')
                
                outfile = [VSData.vars.OTE_outputdir VSData.vars.dirdelimiter matfilelist{k}(1:end-3) 'sfb'];
                ...
                func_VSformants2ssff([mdata.sF1,mdata.sF2,mdata.sF3,mdata.sF4,mdata.sB1,mdata.sB2,mdata.sB3,mdata.sB4], 's', outfile, VSData.vars);
...
messages{length(matfilelist)+1} = sprintf('Completed. %d parameters not found.', errcnt);
set(MBoxHandles.listbox_messages, 'String', messages, 'Value', k);
set(handles.listbox_matfilelist, 'Value', k);
drawnow;
