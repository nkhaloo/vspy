...
% Last Modified by GUIDE v2.5 30-Jan-2018 13:22:58
...
set(handles.edit_Formants_Praat_num_formants, 'String', num2str(vars.FormantsPraatNumFormants));

set(handles.edit_Formants_Snack_preemphasis, 'String', num2str(vars.preemphasis));
set(handles.edit_Formants_Snack_lpcOrder, 'String', num2str(vars.lpcOrder));
...
set(handles.edit_Formants_Praat_max_formant_freq, 'String', num2str(vars.FormantsPraatMaxFormantFreq));
...
set(handles.popupmenu_Formants_Bandwidths, 'String', vars.BandwidthMethods);
for i=1:length(vars.BandwidthMethods)
    if (strcmp(vars.BandwidthMethod, vars.BandwidthMethods{i}))
        set(handles.popupmenu_Formants_Bandwidths, 'Value', i);
        break;
    end
end
...
function edit_Formants_Snack_lpcOrder_Callback(hObject, eventdata, handles)
% hObject    handle to edit_Formants_Snack_lpcOrder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_Formants_Snack_lpcOrder as text
%        str2double(get(hObject,'String')) returns contents of edit_Formants_Snack_lpcOrder as a double
VSData = guidata(handles.VSHandle);
vars = VSData.vars;
num = str2double(get(hObject, 'String')); 
if (isempty(num))
    set(hObject, 'String', num2str(vars.lpcOrder));
else
    num = num(1);
    VSData.vars.lpcOrder = num;
    guidata(handles.VSHandle, VSData);
    set(hObject, 'String', num2str(num))
end

% --- Executes during object creation, after setting all properties.
function edit_Formants_Snack_lpcOrder_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_Formants_Snack_lpcOrder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
if (get(hObject, 'Value') == 1)
    ...
    if (get(handles.radiobutton_Formants_Other, 'Value') == 1) % set back to Snack
        set(handles.radiobutton_Formants_Snack, 'Value', 1);
        VSData.vars.FMTalgorithm = 'Formants (Snack)';
    end    
end    
...
switch get(eventdata.NewValue, 'Tag')
    ...
    case 'radiobutton_Formants_Praat'
        VSData.vars.FMTalgorithm = 'Formants (Praat)';
    case 'radiobutton_Formants_Other'
        VSData.vars.FMTalgorithm = 'Formants (Other)';        
    otherwise
end
guidata(handles.VSHandle, VSData);
...
matdata = load([pathname filename]);
...
function edit_Formants_Praat_max_formant_freq_Callback(hObject, eventdata, handles)
% hObject    handle to edit_Formants_Praat_max_formant_freq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_Formants_Praat_max_formant_freq as text
%        str2double(get(hObject,'String')) returns contents of edit_Formants_Praat_max_formant_freq as a double
VSData = guidata(handles.VSHandle);
vars = VSData.vars;
num = round(str2double(get(hObject, 'String')));
if (isempty(num) || num < 300 || num > 10000)
    set(hObject, 'String', num2str(vars.FormantsPraatMaxFormantFreq));
else
    VSData.vars.FormantsPraatMaxFormantFreq = num;
    guidata(handles.VSHandle, VSData);
    set(hObject, 'String', num2str(num))
end
...
% --- Executes during object creation, after setting all properties.
function edit_Formants_Praat_max_formant_freq_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_Formants_Praat_max_formant_freq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit_Formants_Praat_num_formants_Callback(hObject, eventdata, handles)
% hObject    handle to edit_Formants_Praat_num_formants (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_Formants_Praat_num_formants as text
%        str2double(get(hObject,'String')) returns contents of edit_Formants_Praat_num_formants as a double
VSData = guidata(handles.VSHandle);
vars = VSData.vars;
num = str2double(get(hObject, 'String'));
num = round(num / 0.5) * 0.5;  % Praat allows 0.5 increments
if (isempty(num) || num <= 3 || num > 7)
    set(hObject, 'String', num2str(vars.FormantsPraatNumFormants));
else
    VSData.vars.FormantsPraatNumFormants = num;
    guidata(handles.VSHandle, VSData);
    set(hObject, 'String', num2str(num))
end
...
% --- Executes during object creation, after setting all properties.
function edit_Formants_Praat_num_formants_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_Formants_Praat_num_formants (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu_Formants_Bandwidths.
function popupmenu_Formants_Bandwidths_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu_Formants_Bandwidths (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu_Formants_Bandwidths contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu_Formants_Bandwidths
contents = cellstr(get(hObject,'String'));
selected = contents{get(hObject,'Value')};

VSData = guidata(handles.VSHandle);
VSData.vars.BandwidthMethod = selected;
guidata(handles.VSHandle, VSData);


% --- Executes during object creation, after setting all properties.
function popupmenu_Formants_Bandwidths_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu_Formants_Bandwidths (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in pushbutton_Install_Praat.
function pushbutton_Install_Praat_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_Install_Praat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
h_installing = msgbox('Downloading Praat... Please wait.', 'Please wait', 'help');
...
if ispc
    if strcmp(computer, 'PCWIN64')
        url = sprintf('http://www.fon.hum.uva.nl/praat/praat%s_win64.zip', verPraat);
        urlAlt = sprintf('http://www.fon.hum.uva.nl/praat/old/%s/praat%s_win64.zip', verPraat, verPraat);
        zipUrl = 'http://www.7-zip.org/a/7z1604-x64.exe';
        
    else
        url = sprintf('http://www.fon.hum.uva.nl/praat/praat%s_win32.zip', verPraat);
        urlAlt = sprintf('http://www.fon.hum.uva.nl/praat/old/%s/praat%s_win32.zip', verPraat);
        zipUrl = 'http://www.7-zip.org/a/7z1604.exe';
    end
    dstFileName = 'Praat/praat_win.zip';
    
elseif ismac
    url = sprintf('http://www.fon.hum.uva.nl/praat/praat%s_mac64.dmg', verPraat);
    urlAlt = sprintf('http://www.fon.hum.uva.nl/praat/old/%s/praat%s_mac64.dmg', verPraat, verPraat);
    dstFileName = 'Praat/praat_mac64.dmg';
else
...
if str2double( v(1:3) ) < 8.4
    try
        urlwrite(url,dstFileName)
    catch
        try
            urlwrite(urlAlt,filename)
        catch
            delete(h_installing)
            h = msgbox('Failed to download Praat. Visit http://www.fon.hum.uva.nl/praat/ to manually download Praat. Refer to README in VoiceSauce/Praat folder.', 'Download failed');
            return;
        end
    end
else
    ...
    try
        websave(dstFileName,url);
    catch
        
        try
            websave(dstFileName, urlAlt);
        catch
            %err_download = true;
            delete(h_installing)
            h = msgbox('Failed to download Praat. Visit http://www.fon.hum.uva.nl/praat/ to manually download Praat. Refer to README in VoiceSauce/Praat folder.', 'Download failed');
            ...
            % Download failure
            % Need to show the link to Praat website and
            % ask the user to download and install it manually
        end
    end
...
if ispc    
    try
        unzip(dstFileName, 'Praat')
    catch
        h = msgbox('Failed to install Praat. Refer to README in VoiceSauce/Praat folder for manual install.', 'Install failed');
        return;
    end
    
else
    
    cmd_mount = sprintf('hdiutil attach %s', dstFileName); 
    err = unix(cmd_mount);
    if err
        h = msgbox('Failed to mount Praat. Refer to README in VoiceSauce/Praat folder for manual install.', 'Install failed');
        return;
    end
    
    pathMount = sprintf('/Volumes/Praat64_%s', verPraat);
    try 
        copyfile([pathMount '/Praat.app'], [dirPraat '/Praat.app']);
    catch
        h = msgbox('Failed to mount Praat. Refer to README in VoiceSauce/Praat folder for manual install.', 'Install failed');
        return;        
    end
    
    cmd_unmount = sprintf('hdiutil detach %s', pathMount);
    err = unix(cmd_unmount);
    if err
        h = msgbox('Failed to unmount Praat. Refer to README in VoiceSauce/Praat folder for manual install.', 'Warning');
    end  
end
...
h_installed = msgbox('Praat is installed and ready to be used on VoiceSauce.', 'Ready', 'help');
